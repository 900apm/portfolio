...
'<div class="portfolio-window window">'+
  ...
  '<div class="wrapper">'+
    ...
    '<p>PSD conversion of a single page responsive website. Created exclusively with only floats and clearfix for positioning.</p>'+
...
'<div class="freelance-window window">'+
  ...
  '<div class="wrapper">'+
    ...
    '</div >'+
    '<p>Sparkcapture is a media company that specifically deals with creating content for car dealership photos and videos.</p>'+
    
    '<p>I have designed and developed a multipage responsive website featuring a working image gallery for photos and popup modals for the videos page. The site also includes interactive image sliders to compare different packages. Created with SCSS, JavaScript and jQuery</p>'+
    ...
    '<p>Dumbmoney.ca is a website to help Mitchell Huynh expand his online presence and also help sell his book and web course.</p>' +

    "<p>I have designed and developed a custom wordpress theme for dumbmoney.ca, users are able to register and purchase web courses through learndash and woocommerce, returning users are able to login. Created with PHP, SCSS, JavaScript and jQuery. Also includes a video testimonial from Kevin O'Leary!  </p>" +
  ...
  // resize portfolio-window button
    ...
    .on("click", function () {
      ...
      if (clickCounter % 2 != 0) {
        ...
        $(this).parents(".freelance-window").animate({
          top: "5%",
          left: $(this).parent().width() / 2 - 420 / 2,
          height: "550",
          width: "420"
        });
      }
